...
export default function RegisterPage() {
  ...
  // ── Register email & password (tidak berubah) ───────────────────────────────
  ...
  // ── Daftar dengan Google (DIPERBAIKI) ──────────────────────────────────────
            ...
            <div className="mt-10 grid grid-cols-3 gap-3">
              {STATS.map(({ icon: Icon, value, label }) => (
                ...
                >
                  ...
                  <div className="text-blue-200/70 text-[11px] font-medium leading-tight">
                    {label}
                  </div>
                </div>
              ))}
            ...
            <div className="px-7 pt-7 pb-7">
              ...
              <form onSubmit={handleRegister} className="space-y-4">
                  ...
                  {password.length > 0 && (
                    <div className="mt-2.5 space-y-2">
                      <div className="flex items-center gap-2">
                        ...
                        <span
                          className={`text-xs font-bold min-w-[40px] text-right ${strength.color}`}
                        >
                          {strength.label}
                        </span>
                      </div>
                            ...
                            >
                              ...
                              >
                                {passed ? (
                                  ...
                                  <X
                                    className="w-2 h-2 text-slate-300 dark:text-slate-600"
                                    strokeWidth={2.5}
                                  />
                                )}
                              </div>
                ...
                <div>
                  ...
                  {passwordMatch && (
                    <p className="text-xs font-semibold text-green-600 dark:text-green-400 mt-1.5 flex items-center gap-1">
                      <Check className="w-3 h-3" strokeWidth={3} /> Password
                      cocok
                    </p>
                  )}
                </div>
                ...
                <div className="flex items-start gap-2.5 pt-1">
                  ...
                  <p
                    className="text-sm text-slate-500 dark:text-slate-400 font-medium leading-relaxed select-none cursor-pointer"
                    onClick={() => setAgreeTerms(!agreeTerms)}
                  >
                    Saya menyetujui{" "}
                    <Link
                      href="/privacy"
                      className="text-[#0F52BA] dark:text-blue-400 font-semibold hover:underline"
