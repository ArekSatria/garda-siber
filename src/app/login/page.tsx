            ...
            <div className="px-8 pt-8 pb-8">
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <span className="text-sm text-slate-600 dark:text-slate-400 font-medium select-none cursor-pointer" onClick={() => setRememberMe(!rememberMe)}>
              ...
              <p className="text-center text-sm text-slate-500 dark:text-slate-400 mt-6">
                Belum punya akun?{" "}
                <Link href="/register" className="font-bold text-[#0F52BA] dark:text-blue-400 hover:underline">
                  Daftar Sekarang
                </Link>
              </p>
            </div>
