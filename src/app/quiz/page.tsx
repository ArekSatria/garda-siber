              ...
              <div className="p-10">
                <div className="grid grid-cols-3 gap-4 mb-10">
                  <div className="text-center p-4 bg-slate-50 rounded-2xl">
                    <Target size={22} className="text-[#0F52BA] mx-auto mb-2" />
                  ...
                  <div className="text-center p-4 bg-slate-50 rounded-2xl">
                    <Clock size={22} className="text-[#0F52BA] mx-auto mb-2" />
                    <p className="font-black text-slate-900 text-lg">~5 mnt</p>
                    <p className="text-slate-400 text-xs font-bold uppercase tracking-wider">
                      Durasi
                    </p>
                  </div>
                  <div className="text-center p-4 bg-slate-50 rounded-2xl">
                    ...
                    />
                    <p className="font-black text-slate-900 text-lg">3 tipe</p>
                    <p className="text-slate-400 text-xs font-bold uppercase tracking-wider">
                      Format
                    </p>
                  </div>
